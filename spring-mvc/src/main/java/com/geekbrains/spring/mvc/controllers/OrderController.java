...
import com.geekbrains.spring.mvc.services.OrderService;
import com.geekbrains.spring.mvc.services.OrderServiceImpl;
...
public class OrderController {
    ...
    public String getOrderPage(Model model) {
        List<com.geekbrains.spring.mvc.model.Order> orders = orderService.getAll();
